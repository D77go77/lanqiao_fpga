...
set rc [catch {
  ...
  add_files -quiet D:/01_my_document/desktop/01_contest_about/07_FPGA_files/CT137Xilinx/my_code/100_sim2WithE2prom_error/100_sim2.runs/synth_1/main.dcp
  ...
  link_design -top main -part xc7s6ftgb196-1
